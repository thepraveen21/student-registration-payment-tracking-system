    ...
    <div class="mb-4 md:mb-6 lg:mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div class="mb-3 sm:mb-0">
                ...
                <p class="mt-1 text-xs md:text-sm text-gray-600">Update payment information for <?php echo e($payment->student->name); ?></p>
            </div>
        ...
        <form action="<?php echo e(route('reception.payments.update', $payment)); ?>" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 lg:gap-6">
                    ...
                    <div class="flex items-center bg-gray-50 border border-gray-300 rounded-lg p-2 md:p-3">
                        <div class="flex-shrink-0 w-8 h-8 md:w-10 md:h-10 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-lg flex items-center justify-center mr-2 md:mr-3">
                            <span class="text-blue-600 font-semibold text-xs md:text-sm">
                                <?php echo e(substr($payment->student->first_name, 0, 1)); ?><?php echo e(substr($payment->student->last_name, 0, 1)); ?>

                            </span>
                        </div>
                        <div>
                            <p class="text-sm md:text-base font-medium text-gray-900"><?php echo e($payment->student->name); ?></p>
                            <p class="text-xs text-gray-600"><?php echo e($payment->student->registration_number); ?></p>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <input type="number" name="month_number" id="month_number" value="<?php echo e($payment->month_number); ?>" 
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="amount" id="amount" value="<?php echo e($payment->amount); ?>" 
                ...
                <div>
                    ...
                    <div class="flex items-center bg-gray-50 border border-gray-300 rounded-lg p-2 md:p-3">
                        ...
                        <div>
                            <p class="text-sm md:text-base font-medium text-gray-900"><?php echo e($payment_date_formatted); ?></p>
                            <p class="text-xs text-gray-600">Original payment date</p>
                        </div>
                    </div>
                    <input type="hidden" id="payment_date" value="<?php echo e($payment_date_formatted); ?>">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="notes" id="notes" rows="2" md:rows="3"
                              class="block w-full px-2 py-1.5 md:px-3 md:py-2 lg:px-3 lg:py-2.5 border border-gray-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 text-sm md:text-base"
                              placeholder="Enter any additional notes about this payment"><?php echo e($payment->notes); ?></textarea>
                </div>
            </div>
...
<?php echo $__env->make('layouts.reception', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Project\Student Management System\resources\views/reception/payments/edit.blade.php ENDPATH**/ ?>
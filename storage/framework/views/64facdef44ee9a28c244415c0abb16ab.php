        ...
        <form action="<?php echo e(route('reception.payments.update', $payment)); ?>" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="datetime-local" id="payment_date" value="<?php echo e($payment_date_formatted); ?>" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 bg-gray-200 leading-tight focus:outline-none focus:shadow-outline" disabled>
                </div>

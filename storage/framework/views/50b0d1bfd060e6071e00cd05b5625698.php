    ...
    <div class="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <p class="text-gray-800"><?php echo e($student->date_of_birth ? $student->date_of_birth->format('M j, Y') : 'N/A'); ?></p>
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Course</label>
                <p class="text-gray-800"><?php echo e($student->course->name ?? 'N/A'); ?></p>
            </div>
            <div>
...
function printQR() {
    ...
    if (qrContainer) {
        ...
        printWindow.document.write(`
            <html>
                <head>
                    <title>QR Code - <?php echo e($student->registration_number); ?></title>
                    <style>
                        @page { margin: 0; }
                        body { 
                            display: flex; 
                ...
                <body>
                    <div class="qr-container">
                        ...
                        <p><?php echo e($student->registration_number); ?></p>
                        <p><?php echo e($student->course->name ?? 'N/A'); ?></p>
                        <div class="qr-code">
                            ${qrContainer.innerHTML}
                        </div>
                        <p class="code"><?php echo e($student->registration_number); ?></p>
                        <p style="margin-top: 15px; font-size: 12px; color: #9ca3af;">
                            Printed on <?php echo e(now()->format('M d, Y')); ?>
...
<?php echo $__env->make('layouts.reception', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Innovior\Desktop\4.11 time\Student Management System\resources\views/reception/students/show.blade.php ENDPATH**/ ?>
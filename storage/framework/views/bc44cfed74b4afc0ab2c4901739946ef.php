...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-gray-900"><?php echo e($monthlyPayments->count()); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-green-700">Rs. <?php echo e(number_format($monthlyPayments->sum('amount'), 2)); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-gray-900"><?php echo e($monthlyPayments->pluck('student_id')->unique()->count()); ?></p>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $grouped; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hour => $records): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="flex items-center mb-2 sm:mb-0">
                        ...
                        <div>
                            ...
                            <h4 class="text-xl font-bold text-gray-900">
                                <?php echo e(\Carbon\Carbon::parse($hour . ':00:00')->format('F d, Y')); ?>

                            </h4>
                            <div class="flex items-center mt-1">
                                <!-- LARGER TIME -->
                                <span class="text-lg font-bold text-blue-700 mr-3">
                                    <?php echo e(\Carbon\Carbon::parse($hour . ':00:00')->format('h:00 A')); ?>
                    ...
                    <div class="flex flex-col lg:flex-row lg:items-center gap-4">
                        ...
                        <div class="lg:w-1/4">
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-600 mt-0.5"><?php echo e($pay->student->reg_no); ?></p>
                                    <div class="flex items-center mt-2">
                                        ...
                                        <span class="text-xs text-gray-600"><?php echo e($pay->course->name); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="lg:w-1/5">
                            <div class="flex items-center text-sm text-gray-700">
                                ...
                                <span><?php echo e($pay->student->center->name ?? 'N/A'); ?></span>
                            </div>
                        </div>
                            ...
                            <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg p-4 border border-green-100">
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-lg font-bold text-green-700 mt-1">Rs. <?php echo e(number_format($pay->amount, 2)); ?></p>
                                    </div>
                                    <!-- LARGER PAYMENT TIME -->
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <p class="text-lg font-bold text-gray-900 mt-1"><?php echo e($pay->payment_date->format('M d, Y')); ?></p>
                                    </div>
                                </div>
                                <?php if($pay->notes): ?>
                                <div class="mt-3 pt-3 border-t border-green-200">
                                    <p class="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Notes</p>
                                    <p class="text-xs text-gray-700 bg-white px-3 py-2 rounded border border-gray-200"><?php echo e($pay->notes); ?></p>
                                </div>
                                <?php endif; ?>
                                <?php if($pay->updated_at->ne($pay->created_at)): ?>
                                <div class="mt-3 pt-3 border-t border-green-200">
                                    <p class="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Last Edited</p>
                                    <p class="text-xs text-gray-700"><?php echo e($pay->updated_at->format('M d, Y, h:i A')); ?></p>
                                </div>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="lg:w-1/5">
                            <div class="text-right">
                                ...
                                <p class="text-sm font-medium text-gray-900 mt-1"><?php echo e($pay->recordedBy->name ?? 'N/A'); ?></p>
                                <p class="text-xs text-gray-500 mt-0.5">via Reception</p>
                                <div class="mt-4 flex justify-end space-x-2">
                                    <a href="<?php echo e(route('reception.payments.edit', $pay)); ?>" class="text-blue-600 hover:text-blue-900">Edit</a>
                                    <form action="<?php echo e(route('reception.payments.destroy', $pay)); ?>" method="POST" onsubmit="return confirm('Are you sure?');">
                                        <?php echo csrf_field(); ?>
        ...
        <?php if($monthlyPayments->count()): ?>
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                <div class="text-sm text-gray-700">
                    Showing <span class="font-semibold"><?php echo e($monthlyPayments->count()); ?></span> payment records • 
                    Total Amount: <span class="font-semibold text-green-700">Rs. <?php echo e(number_format($monthlyPayments->sum('amount'), 2)); ?></span>
                </div>
            </div>
        <?php endif; ?>
    </div>
...
<?php echo $__env->make('layouts.reception', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\New folder (17)\Student Management System\resources\views/reception/payments/index.blade.php ENDPATH**/ ?>
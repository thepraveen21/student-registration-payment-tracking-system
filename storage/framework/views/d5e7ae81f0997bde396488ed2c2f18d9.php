<?php $__env->startSection('header', 'Add Payment via QR'); ?>
...
<div id="paymentModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
    <div class="bg-white w-full max-w-md p-6 rounded-xl shadow-lg transform scale-90 opacity-0 transition-all duration-300" id="paymentModalContent">
        ...
        <form id="paymentForm">
            ...
            <input type="hidden" name="payment_date" id="payment_date" value="<?php echo e(now()); ?>">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function fetchStudent(code) {
        fetch("<?php echo e(route('reception.payments.getStudent')); ?>", {
            method: "POST",
            headers: {
    ...
    document.getElementById("paymentForm").addEventListener("submit", function(e) {
        ...
        fetch("<?php echo e(route('reception.payments.store')); ?>", {
            method: "POST",
...
<?php echo $__env->make('layouts.reception', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\New folder (14)\Student Management System\resources\views/reception/payments/create.blade.php ENDPATH**/ ?>
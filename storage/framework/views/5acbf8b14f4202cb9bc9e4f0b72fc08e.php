                    ...
                    <div class="space-y-1 md:space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" 
                                   id="fee" 
                                   name="fee" 
                                   value="<?php echo e(old('fee')); ?>"
                                   step="0.01"
                                   min="0"
                                   class="block w-full pl-8 md:pl-10 pr-3 py-1.5 md:py-2 lg:py-2.5 border border-gray-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 text-sm md:text-base <?php $__errorArgs = ['fee'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 focus:ring-red-500 focus:border-red-500 <?php unset($message);
                                        ...
                                        <div class="flex flex-wrap items-center gap-2 md:gap-3 mt-1">
                                            ...
                                            <?php if($course->fee): ?>
                                                <div class="flex items-center text-xs text-gray-500">
                                                    ...
                                                    Rs.<?php echo e(number_format($course->fee, 2)); ?>

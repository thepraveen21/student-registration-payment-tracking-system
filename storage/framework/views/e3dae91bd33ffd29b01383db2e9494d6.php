            ...
            <div class="bg-green-500 text-white rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold">₹<?php echo e(number_format($stats['total_payments'], 2)); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-yellow-500 text-white rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold">₹<?php echo e(number_format($stats['pending_payments'], 2)); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-red-500 text-white rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold">₹<?php echo e(number_format($stats['overdue_payments'], 2)); ?></p>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Projects\Laravel\New folder\Student Management System\resources\views/admin/reports/index.blade.php ENDPATH**/ ?>
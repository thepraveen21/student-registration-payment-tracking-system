    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-6 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                <div class="relative">
                    <select id="event-filter" class="appearance-none bg-white border border-gray-300 rounded-lg py-2 px-4 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                <div class="relative">
                    <select id="task-filter" class="appearance-none bg-white border border-gray-300 rounded-lg py-2 px-4 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Auto-filter events on change
        document.getElementById('event-filter').addEventListener('change', function() {
            const filterValue = this.value;
            const eventItems = document.querySelectorAll('[class*="bg-white"] > .divide-y > div:not([class*="text-center"])');
            
            eventItems.forEach(item => {
                const statusBadge = item.querySelector('[class*="bg-"]:not(.task-checkbox)');
                if (statusBadge) {
        ...
        document.getElementById('task-filter').addEventListener('change', function() {
            ...
            taskItems.forEach(item => {
                const priorityBadge = item.querySelector('[class*="bg-"]:not(.task-checkbox)');
                if (priorityBadge) {
...
<?php echo $__env->make('layouts.reception', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\Projects\innovior info\Student Management System\resources\views/reception/schedule/index.blade.php ENDPATH**/ ?>
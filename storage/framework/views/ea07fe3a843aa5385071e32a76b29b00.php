    ...
    <div class="email-container">
        ...
        <div class="content">
            ...
            <div class="info-box">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value"><?php echo e($registrationNumber); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Course Name:</span>
                    <span class="info-value"><?php echo e($courseName); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Center:</span>
                    <span class="info-value"><?php echo e($centerName); ?></span>
                </div>
                <div class="info-row">
        ...
        <div class="footer">
            ...
            <p style="margin: 15px 0 5px 0; color: #999;">
                © <?php echo e(date('Y')); ?> Student Management System. All rights reserved.
            </p>
        </div>
    </div>
</body>
</html>
<?php /**PATH E:\Project\Student Management System\resources\views/emails/payment_overdue.blade.php ENDPATH**/ ?>
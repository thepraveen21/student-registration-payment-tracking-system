...
<head>
    ...
    <title>Payment-wise Student Report - <?php echo e(now()->format('Y-m-d')); ?></title>
        ...
        <div class="report-header">
            <div class="header-left">
                ...
                <p class="report-subtitle">
                    ...
                    <span><i class="fas fa-calendar-alt"></i> Generated: <?php echo e(now()->format('M d, Y h:i A')); ?></span>
                </p>
            </div>
        ...
        <div class="stats-horizontal">
            ...
            <div class="stat-item">
                ...
                <div class="stat-content">
                    ...
                    <div class="stat-value">Rs. <?php echo e(number_format($students->sum('total_paid'), 2)); ?></div>
                </div>
            </div>
            ...
            <div class="stat-item">
                ...
                <div class="stat-content">
                    ...
                    <div class="stat-value">Rs. <?php echo e(number_format($students->sum('total_due'), 2)); ?></div>
                </div>
            </div>
            ...
            <div class="stat-item">
                ...
                <div class="stat-content">
                    ...
                    <div class="stat-value">Rs. <?php echo e(number_format($students->sum('balance'), 2)); ?></div>
                </div>
            </div>
        </div>
        ...
        <div class="table-container-compact">
            <div class="table-header-compact">
                <h3 class="table-title">
                    ...
                    <span style="font-size: 13px; color: var(--gray-600); margin-left: auto;">
                        <?php echo e($students->count()); ?> records
                    </span>
                </h3>
            </div>
                        ...
                        <tr>
                            ...
                            <td class="text-left">
                                <div class="student-name">
                                    <?php echo e($data['student']->first_name); ?> <?php echo e($data['student']->last_name); ?>

                                </div>
                                <span class="student-id"><?php echo e($data['student']->registration_number); ?></span>
                            </td>
                            ...
                            <!-- Balance -->
                            <td class="text-right">
                                <div class="currency-value <?php echo e($data['balance'] > 0 ? 'currency-negative' : 'currency-positive'); ?>">
                                    ...
                                    <?php endif; ?>
                                    Rs. <?php echo e(number_format(abs($data['balance']), 2)); ?>
            ...
            <div class="compact-footer">
                <div class="footer-left">
                    ...
                    <span>Total analyzed: <?php echo e($students->count()); ?> students</span>
                </div>
                <div class="footer-right">
                    <i class="fas fa-print" style="font-size: 13px;"></i>
                    <span>Landscape Report • <?php echo e(now()->format('M d, Y h:i A')); ?></span>
                </div>
            </div>
        </div>
    </div>
</body>
</html><?php /**PATH C:\Users\Dell\Desktop\New folder (17)\Student Management System\resources\views/admin/reports/pdf/payment-wise-students.blade.php ENDPATH**/ ?>
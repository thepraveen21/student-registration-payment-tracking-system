...
<div class="container mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <!-- Course Reports -->
            <a href="<?php echo e(route('admin.reports.course-wise-students')); ?>" 
            ...
            <div class="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
                ...
                <div class="p-6 space-y-3">
                    ...
                    <a href="<?php echo e(route('admin.reports.payment-wise-students')); ?>" 
                       class="flex items-center justify-between p-3 bg-green-50 hover:bg-green-100 rounded-lg transition-colors duration-200">
                        <div class="flex items-center">
                            <svg class="w-5 h-5 text-green-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\New folder (17)\Student Management System\resources\views/admin/reports/index.blade.php ENDPATH**/ ?>
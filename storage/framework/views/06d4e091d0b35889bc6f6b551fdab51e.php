            ...
            <div class="mt-4 sm:mt-0">
                <div class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-green-100 to-emerald-100 rounded-lg border border-green-200">
                    ...
                    <span class="text-sm font-medium text-green-800">
                        Receipt #<?php echo e($payment->receipt_number ?? 'N/A'); ?>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden mb-8">
            ...
            <div class="px-6 py-4 bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    ...
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold <?php echo e($payment->status == 'completed' ? 'bg-green-100 text-green-800' : ($payment->status == 'pending' ? 'bg-yellow-100 text-yellow-800' : 'bg-red-100 text-red-800')); ?>">
            ...
            <div class="px-6 py-8 bg-gradient-to-r from-green-50 to-emerald-50 border-b border-green-100">
                <div class="text-center">
                    ...
                    <p class="mt-2 text-3xl md:text-4xl font-bold text-green-700">Rs. <?php echo e(number_format($payment->amount, 2)); ?></p>
                    ...
                    <div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="mt-1 text-base text-gray-900 font-medium"><?php echo e($payment->student->first_name); ?> <?php echo e($payment->student->last_name); ?></p>
                            </div>
                            <?php if($payment->student->registration_number): ?>
                            <div>
                                <p class="text-sm font-medium text-gray-500">Registration Number</p>
                                <p class="mt-1 text-base text-gray-900"><?php echo e($payment->student->registration_number); ?></p>
                            </div>
                            <?php endif; ?>
                            <?php if($payment->student->email): ?>
                            <div>
                                <p class="text-sm font-medium text-gray-500">Email Address</p>
                                <p class="mt-1 text-base text-gray-900"><?php echo e($payment->student->email); ?></p>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                ?>
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium mt-1 <?php echo e($color); ?>">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-base text-gray-900"><?php echo e(\Carbon\Carbon::parse($payment->payment_date)->format('F d, Y')); ?></p>
                            </div>

                            <?php if($payment->receipt_number): ?>
                            <div>
                                <p class="text-sm font-medium text-gray-500">Receipt Number</p>
                                <p class="mt-1 text-base text-gray-900 font-mono"><?php echo e($payment->receipt_number); ?></p>
                            </div>
                            <?php endif; ?>
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-base text-gray-900"><?php echo e($payment->notes); ?></p>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
            ...
            <div class="px-6 py-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <p class="mt-1 text-base text-gray-900"><?php echo e($payment->created_at->format('F d, Y \a\t h:i A')); ?></p>
                    </div>
                    <div>
                        <p class="text-sm font-medium text-gray-500">Last Updated</p>
                        <p class="mt-1 text-base text-gray-900"><?php echo e($payment->updated_at->format('F d, Y \a\t h:i A')); ?></p>
                    </div>
                </div>
            </div>
        </div>

...
<div class="container mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="py-8">
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
            ...
            <!-- Form -->
            <form action="<?php echo e(route('admin.payments.update', $payment->id)); ?>" method="POST" class="px-6 py-6">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\New folder (17)\Student Management System\resources\views/admin/payments/edit.blade.php ENDPATH**/ ?>
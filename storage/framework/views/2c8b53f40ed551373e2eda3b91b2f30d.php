        ...
        <?php if($monthlyPayments->count()): ?>
            ...
            <div class="px-4 md:px-6 py-3 md:py-4 bg-gray-50 border-t border-gray-200">
                <div class="text-xs md:text-sm text-gray-700 flex flex-col sm:flex-row sm:items-center space-y-1 sm:space-y-0">
                    <span>Showing <span class="font-semibold"><?php echo e($monthlyPayments->count()); ?></span> payment records</span>
                    <span class="hidden sm:inline mx-2">•</span>
                    <span>Total Amount: <span class="font-semibold text-green-700">Rs. <?php echo e(number_format($monthlyPayments->sum('amount'), 2)); ?></span></span>
                </div>
            </div>
        <?php endif; ?>
    </div>

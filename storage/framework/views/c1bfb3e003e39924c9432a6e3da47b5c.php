            ...
            <div class="px-6 py-6 bg-gradient-to-r from-blue-50 to-indigo-100 border-b border-blue-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div class="ml-6">
                            ...
                            <div class="mt-2 flex flex-wrap items-center gap-3">
                                ...
                                <span class="text-sm text-gray-600">
                                    Member since <?php echo e($student->created_at->format('M d, Y')); ?>
                    ...
                    <div class="mt-4 sm:mt-0">
                        <a href="<?php echo e(route('admin.payments.create')); ?>?student_id=<?php echo e($student->id); ?>" 
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <p class="mt-1 text-base text-gray-900"><?php echo e($student->first_name); ?></p>
                            </div>
                            <div>
                                <p class="text-sm font-medium text-gray-500">Last Name</p>
                                <p class="mt-1 text-base text-gray-900"><?php echo e($student->last_name); ?></p>
                            </div>
                            <div>
                                <p class="text-sm font-medium text-gray-500">Email Address</p>
                                <p class="mt-1 text-base text-gray-900"><?php echo e($student->email); ?></p>
                            </div>
                            <div>
                                <p class="text-sm font-medium text-gray-500">Date of Birth</p>
                                <p class="mt-1 text-base text-gray-900"><?php echo e($student->date_of_birth ? \Carbon\Carbon::parse($student->date_of_birth)->format('F d, Y') : 'N/A'); ?></p>
                            </div>
                            <div>
                                <p class="text-sm font-medium text-gray-500">Student Phone</p>
                                <p class="mt-1 text-base text-gray-900"><?php echo e($student->student_phone ?? 'N/A'); ?></p>
                            </div>
                            <div>
                                <p class="text-sm font-medium text-gray-500">Parent Phone</p>
                                <p class="mt-1 text-base text-gray-900"><?php echo e($student->parent_phone ?? 'N/A'); ?></p>
                            </div>
                            <div class="md:col-span-2">
                                <p class="text-sm font-medium text-gray-500">Address</p>
                                <p class="mt-1 text-base text-gray-900"><?php echo e($student->address ?? 'N/A'); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <p class="mt-1 text-base text-gray-900"><?php echo e($student->course->name ?? 'N/A'); ?></p>
                            </div>
                            <div>
                                <p class="text-sm font-medium text-gray-500">Center</p>
                                <p class="mt-1 text-base text-gray-900"><?php echo e($student->center->name ?? 'N/A'); ?></p>
                            </div>
                            <div>
                                <p class="text-sm font-medium text-gray-500">Registration Number</p>
                                <p class="mt-1 text-base text-gray-900 font-mono"><?php echo e($student->registration_number); ?></p>
                            </div>
                            <div>
                                <p class="text-sm font-medium text-gray-500">Registration Date</p>
                                <p class="mt-1 text-base text-gray-900"><?php echo e($student->created_at->format('F d, Y')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="space-y-6">
                    ...
                    <div class="p-6">
                        ...
                        <div class="text-center">
                            <div class="bg-white p-4 rounded-lg border border-gray-300 inline-block">
                                <img src="<?php echo e($student->qr_code_url); ?>" 
                                     alt="Student QR Code" 
                            ...
                            <div class="mt-4 flex flex-col sm:flex-row sm:space-x-3 space-y-3 sm:space-y-0">
                                <a href="<?php echo e($student->qr_code_url); ?>" 
                                   download="QR_<?php echo e($student->registration_number); ?>.svg"
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-6 space-y-3">
                        ...
                        <form action="<?php echo e(route('admin.students.destroy', $student->id)); ?>" method="POST" class="w-full">
                            <?php echo csrf_field(); ?>
...
function printQR() {
    ...
    if (qrImage) {
        ...
        printWindow.document.write(`
            <html>
                <head>
                    <title>Print QR Code - <?php echo e($student->registration_number); ?></title>
                    <style>
                        body { 
                            display: flex; 
                ...
                <body>
                    <div class="qr-container">
                        <h2><?php echo e($student->first_name); ?> <?php echo e($student->last_name); ?></h2>
                        <p>Registration: <?php echo e($student->registration_number); ?></p>
                        <p>Course: <?php echo e($student->course->name ?? 'N/A'); ?></p>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\New folder (17)\Student Management System\resources\views/admin/students/show.blade.php ENDPATH**/ ?>
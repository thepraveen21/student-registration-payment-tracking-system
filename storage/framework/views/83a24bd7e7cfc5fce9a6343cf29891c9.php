            ...
            <div class="col-lg-10 col-md-9">
                <div class="content-header">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <small class="text-muted"><?php echo e(now()->format('l, F j, Y - g:i A')); ?></small>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e(number_format($totalStudents)); ?></div>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($todaysRegistrations); ?></div>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($pendingPayments); ?></div>
                                        <?php if($overduePayments > 0): ?>
                                            <div class="text-xs text-danger mt-1"><?php echo e($overduePayments); ?> overdue</div>
                                        <?php endif; ?>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">$<?php echo e(number_format($todaysRevenue, 2)); ?></div>
                                        <?php
                                            $revenueChange = $yesterdaysRevenue > 0 ? (($todaysRevenue - $yesterdaysRevenue) / $yesterdaysRevenue) * 100 : 0;
                                        ?>
                                        <?php if($revenueChange > 0): ?>
                                            <div class="text-xs text-success mt-1">+<?php echo e(number_format($revenueChange, 1)); ?>% from yesterday</div>
                                        <?php elseif($revenueChange < 0): ?>
                                            <div class="text-xs text-danger mt-1"><?php echo e(number_format($revenueChange, 1)); ?>% from yesterday</div>
                                        <?php else: ?>
                            ...
                            <div class="card-body">
                                <?php $__empty_1 = true; $__currentLoopData = $recentPayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
                                        <div>
                                            <div class="font-weight-bold"><?php echo e($payment->student->first_name); ?> <?php echo e($payment->student->last_name); ?></div>
                                            <small class="text-muted"><?php echo e($payment->payment_date->format('M j, Y')); ?></small>
                                        </div>
                                        <span class="badge bg-success">$<?php echo e(number_format($payment->amount, 2)); ?></span>
                                    </div>
                            ...
                            <div class="card-body">
                                <?php $__empty_1 = true; $__currentLoopData = $recentActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="d-flex align-items-center py-2 border-bottom">
                                        <div class="me-3">
                                            <i class="fas fa-<?php echo e(str_contains(strtolower($activity->action), 'student') ? 'user-plus text-success' : 
                                                (str_contains(strtolower($activity->action), 'payment') ? 'credit-card text-primary' : 
                                                'activity text-secondary')); ?>"></i>
                                        </div>
                                        <div class="flex-grow-1">
                                            <div class="font-weight-bold"><?php echo e($activity->action); ?></div>
                                            <?php if($activity->description): ?>
                                                <small class="text-muted"><?php echo e(Str::limit($activity->description, 50)); ?></small>
                                            <?php endif; ?>
                                            <div class="text-xs text-muted"><?php echo e($activity->created_at->diffForHumans()); ?></div>
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-3 mb-3">
                                        <a href="<?php echo e(route('reception.students.create')); ?>" class="btn btn-primary btn-block">
                                            <i class="fas fa-user-plus"></i> Add Student
                                        </a>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <a href="<?php echo e(route('reception.payments.create')); ?>" class="btn btn-success btn-block">
                                            <i class="fas fa-credit-card"></i> Record Payment
                                        </a>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <a href="<?php echo e(route('reception.students.index')); ?>" class="btn btn-info btn-block">
                                            <i class="fas fa-list"></i> View Students
                                        </a>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <a href="<?php echo e(route('reception.reports.index')); ?>" class="btn btn-warning btn-block">
...
<?php /**PATH C:\Users\Innovior\Desktop\4.11 time\Student Management System\resources\views/Reception.blade.php ENDPATH**/ ?>
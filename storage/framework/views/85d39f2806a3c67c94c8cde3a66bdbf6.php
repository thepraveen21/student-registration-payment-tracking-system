    ...
    <div class="mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-2 text-sm text-gray-600">Manage all student records and information</p>
            </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                        ...
                        <!-- Course & Center -->
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-900 font-medium"><?php echo e($student->course->name ?? 'N/A'); ?></div>
                            <div class="text-sm text-gray-500"><?php echo e($student->center->name ?? 'N/A'); ?></div>
                        </td>
                        
                        <!-- Contact -->
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900"><?php echo e($student->email); ?></div>
                            <div class="text-sm text-gray-500"><?php echo e($student->parent_phone ?? 'No Contact'); ?></div>
                        </td>
                        ...
                        <!-- Registered Date -->
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900"><?php echo e($student->created_at->format('M d, Y')); ?></div>
                            <div class="text-sm text-gray-500"><?php echo e($student->created_at->diffForHumans()); ?></div>
                        </td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\New folder (17)\Student Management System\resources\views/admin/students/index.blade.php ENDPATH**/ ?>
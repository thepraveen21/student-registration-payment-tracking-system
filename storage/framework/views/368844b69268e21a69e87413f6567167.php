    ...
    <div class="mb-4 md:mb-6 lg:mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div class="mb-3 sm:mb-0">
                ...
                <p class="mt-1 text-xs md:text-sm text-gray-600">Update information for <?php echo e($student->first_name); ?> <?php echo e($student->last_name); ?></p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-3 md:p-4 lg:p-6">
        <form action="<?php echo e(route('reception.students.update', $student)); ?>" method="POST">
            ...
            <div class="flex items-center mb-4 md:mb-6 lg:mb-8">
                ...
                <div class="min-w-0">
                    <h2 class="text-base md:text-lg lg:text-xl font-bold text-gray-900 truncate"><?php echo e($student->first_name); ?> <?php echo e($student->last_name); ?></h2>
                    <div class="flex flex-wrap items-center mt-1 gap-1 md:gap-2">
                        <span class="text-xs text-gray-600">ID: <?php echo e($student->id); ?></span>
                        <span class="hidden sm:inline text-xs text-gray-400">•</span>
                        <span class="text-xs font-mono text-gray-600 truncate"><?php echo e($student->registration_number); ?></span>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.reception', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Project\Student Management System\resources\views/reception/students/edit.blade.php ENDPATH**/ ?>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" 
                               ...
                               name="name" 
                               value="{{ old('name') }}"
                               class="block w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 @error('name') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror"
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <textarea id="description" 
                                  name="description" 
                                  rows="4"
                                  class="block w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 @error('description') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror"
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" 
                                   ...
                                   step="0.01"
                                   min="0"
                                   class="block w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 @error('price') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror"
                                   placeholder="0.00"
                                   required>
                        </div>
                        @error('price')
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" 
                                   ...
                                   name="duration" 
                                   value="{{ old('duration') }}"
                                   class="block w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 @error('duration') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror"

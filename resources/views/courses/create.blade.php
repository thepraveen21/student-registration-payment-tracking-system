    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="p-3 md:p-4 lg:p-6">
            <form action="{{ route('courses.store') }}" method="POST" class="space-y-4 md:space-y-5 lg:space-y-6">
                ...
                <!-- Duration and Fee Fields (Side by side on desktop) -->
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 lg:gap-6">
                    ...
                    <!-- Course Fee Field -->
                    <div class="space-y-1 md:space-y-2">
                        <label for="fee" class="block text-xs md:text-sm font-medium text-gray-700">
                            Course Fee (Rs.)
                            <span class="text-red-500">*</span>
                        </label>
                        <div class="relative">
                            ...
                            <input type="number" 
                                   ...
                                   step="0.01"
                                   min="0"
                                   class="block w-full pl-8 md:pl-10 pr-3 py-1.5 md:py-2 lg:py-2.5 border border-gray-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 text-sm md:text-base @error('fee') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror"
                                   placeholder="0.00"
                                   required>
                        </div>
                        @error('fee')
    ...
    if (form) {
        form.addEventListener('submit', function(e) {
            ...
            const requiredFields = [
                ...
                { id: 'fee', message: 'Course fee is required' }
            ];

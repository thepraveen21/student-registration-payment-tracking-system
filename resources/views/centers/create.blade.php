...
<div class="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 md:py-6 lg:py-8">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="p-3 md:p-4 lg:p-6">
            <form action="{{ route('centers.store') }}" method="POST" class="space-y-4 md:space-y-5 lg:space-y-6">
                @csrf
                ...
                <div class="space-y-1 md:space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" 
                               ...
                               name="location" 
                               value="{{ old('location') }}"
                               class="block w-full pl-8 md:pl-10 pr-3 py-1.5 md:py-2 lg:py-2.5 border border-gray-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 text-sm md:text-base @error('location') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror"

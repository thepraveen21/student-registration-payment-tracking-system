                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" 
                               ...
                               name="location" 
                               value="{{ old('location') }}"
                               class="block w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 @error('location') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror"

    ...
    <div class="max-w-2xl mx-auto bg-white shadow-md rounded-lg p-8">
        ...
        <form action="{{ route('reception.students.update', $student) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="email" name="email" id="email" value="{{ $student->email }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>
            <div class="mb-4">
                <label for="phone" class="block text-gray-700 text-sm font-bold mb-2">Phone:</label>
                <input type="text" name="phone" id="phone" value="{{ $student->phone }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>

    ...
    <div class="mb-6 md:mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-1 md:mt-2 text-sm text-gray-600">Complete information for {{ $student->first_name }} {{ $student->last_name }}</p>
            </div>
                    ...
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                        <div>
                            ...
                            <div class="flex items-center mt-2 space-x-4">
                                ...
                                <span class="text-sm text-gray-600">ID: {{ $student->id }}</span>
                                <span class="text-sm text-gray-600">{{ $student->registration_number }}</span>
                            </div>
                        </div>
                        ...
                        <div class="mt-4 md:mt-0 grid grid-cols-3 gap-4">
                            <div class="text-center">
                                ...
                                <div class="text-sm font-medium text-gray-900">{{ optional($student->course)->name ?? 'N/A' }}</div>
                            </div>
                            <div class="text-center">
                                <div class="text-xs text-gray-500 mb-1">Center</div>
                                <div class="text-sm font-medium text-gray-900">{{ optional($student->center)->name ?? 'N/A' }}</div>
                            </div>
                            <div class="text-center">
                                <div class="text-xs text-gray-500 mb-1">Joined</div>
                                <div class="text-sm font-medium text-gray-900">{{ $student->created_at->format('M Y') }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-medium text-gray-900 pl-6">{{ $student->email }}</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-sm font-medium text-gray-900 pl-6">{{ $student->student_phone }}</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-sm font-medium text-gray-900 pl-6">{{ $student->parent_phone ?? 'Not provided' }}</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-sm font-medium text-gray-900 pl-6">
                                ...
                                <span class="text-gray-500 text-sm">({{ \Carbon\Carbon::parse($student->date_of_birth)->age }} years)</span>
                                @endif
                            </p>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <p class="text-sm text-gray-900 pl-6">{{ $student->address ?? 'Not provided' }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-medium text-gray-900 pl-6">{{ optional($student->course)->name ?? 'Not assigned' }}</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-sm font-medium text-gray-900 pl-6">{{ optional($student->center)->name ?? 'Not assigned' }}</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-sm font-medium text-gray-900 pl-6">{{ $student->created_at->format('M d, Y') }}</p>
                            <p class="text-xs text-gray-500 pl-6">{{ $student->created_at->diffForHumans() }}</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-sm font-mono font-medium text-gray-900 bg-gray-50 px-3 py-1.5 rounded-lg pl-6">{{ $student->registration_number }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
                    ...
                    <div class="text-center">
                        <div class="bg-gradient-to-br from-gray-50 to-white border-2 border-gray-100 rounded-xl p-6 mb-4">
                            <img src="{{ asset($student->qr_code_path) }}" alt="QR Code" class="w-48 h-48 mx-auto">
                        </div>

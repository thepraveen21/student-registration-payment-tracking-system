        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-3 md:p-4">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-lg md:text-xl font-bold text-gray-900">{{ $monthlyPayments->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-3 md:p-4">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-lg md:text-xl font-bold text-green-700">Rs. {{ number_format($monthlyPayments->sum('amount'), 2) }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-3 md:p-4">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-lg md:text-xl font-bold text-gray-900">{{ $monthlyPayments->pluck('student_id')->unique()->count() }}</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="flex flex-col lg:flex-row lg:items-center gap-3 md:gap-4">
                        ...
                        <div class="lg:w-1/4 mb-3 md:mb-0">
                            <div class="flex items-start">
                                ...
                                <div class="min-w-0 flex-grow">
                                    ...
                                    <p class="text-xs text-gray-600 mt-0.5 truncate">{{ $pay->student->reg_no }}</p>
                                    <div class="flex items-center mt-1 md:mt-2">
                                        ...
                                        <span class="text-xs text-gray-600 truncate">{{ $pay->course->name }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="lg:w-1/5 mb-3 md:mb-0">
                            <div class="flex items-center text-sm text-gray-700">
                                ...
                                <span class="truncate">{{ $pay->student->center->name ?? 'N/A' }}</span>
                            </div>
                        </div>
                            ...
                            <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg p-3 md:p-4 border border-green-100">
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-base md:text-lg font-bold text-green-700 mt-1">Rs. {{ number_format($pay->amount, 2) }}</p>
                                    </div>
                                    <!-- PAYMENT TIME -->
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <p class="text-base md:text-lg font-bold text-gray-900 mt-1 truncate">{{ $pay->payment_date->format('M d, Y') }}</p>
                                    </div>
                                </div>
                                @if($pay->notes)
                                <div class="mt-2 md:mt-3 pt-2 md:pt-3 border-t border-green-200">
                                    ...
                                    <p class="text-xs text-gray-700 bg-white px-2 md:px-3 py-1.5 md:py-2 rounded border border-gray-200 line-clamp-2">{{ $pay->notes }}</p>
                                </div>
                                @endif
                                @if($pay->updated_at->ne($pay->created_at))
                                <div class="mt-2 md:mt-3 pt-2 md:pt-3 border-t border-green-200">
                                    <p class="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Last Edited</p>
                                    <p class="text-xs text-gray-700 truncate">{{ $pay->updated_at->format('M d, Y, h:i A') }}</p>
                                </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="lg:w-1/5">
                            <div class="text-left lg:text-right">
                                ...
                                <p class="text-sm font-medium text-gray-900 mt-1 truncate">{{ $pay->recordedBy->name ?? 'N/A' }}</p>
                                ...
                                <div class="mt-3 md:mt-4 flex lg:justify-end space-x-2">
                                    ...
                                    <a href="{{ route('reception.payments.edit', $pay) }}" 
                                    ...
                                    <form action="{{ route('reception.payments.destroy', $pay) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this payment?');" class="inline-block">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" 

...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <!-- Assignment Form -->
            <form id="assign-form" action="{{ route('reception.qrcodes.assign') }}" method="POST" class="hidden">
                @csrf
                <div class="space-y-4">
                    <div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="px-6 py-4 bg-gray-50 border-b border-gray-200 flex justify-between items-center">
            ...
            <div class="text-sm text-gray-700">
                <span class="font-semibold">{{ $unassignedQRCodes->total() }}</span> codes available
            </div>
        </div>

        @if($unassignedQRCodes->count())
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach($unassignedQRCodes as $qrCode)
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="text-sm font-mono font-medium text-gray-900">{{ $qrCode->code }}</div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="{{ asset($qrCode->qr_image_path) }}" download 
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <div class="text-sm text-gray-700 mb-4 sm:mb-0">
                        Showing <span class="font-semibold">{{ $unassignedQRCodes->firstItem() }}</span> to 
                        <span class="font-semibold">{{ $unassignedQRCodes->lastItem() }}</span> of 
                        <span class="font-semibold">{{ $unassignedQRCodes->total() }}</span> results
                    </div>

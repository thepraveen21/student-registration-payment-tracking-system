        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-xl md:text-2xl font-bold text-gray-900">{{ $todayCount ?? 0 }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-xl md:text-2xl font-bold text-gray-900">{{ $uniqueCourses ?? 0 }}</p>
                </div>
            </div>
        </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <!-- Contact -->
                                <td class="px-4 md:px-6 py-3 md:py-4 whitespace-nowrap">
                                    <div class="text-xs md:text-sm text-gray-900 truncate max-w-[120px] md:max-w-none">{{ $attendance->student->student_phone }}</div>
                                </td>
                                
                                <!-- Course -->
                                <td class="px-4 md:px-6 py-3 md:py-4">
                                    <div class="text-xs md:text-sm font-medium text-gray-900 truncate max-w-[120px] md:max-w-none">{{ $attendance->student->course->name ?? 'N/A' }}</div>
                                </td>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            <div class="text-xs text-gray-500 truncate">
                                                {{ $attendance->attended_at->format('M d, Y') }}
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-2 md:px-4 py-3 md:py-4 whitespace-nowrap">
                                    <span class="inline-flex items-center px-1.5 py-0.5 md:px-3 md:py-1 rounded-full text-xs md:text-sm font-medium {{ $status == 'Paid' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                                        {{ $status == 'Paid' ? 'P' : 'UP' }}
                                    </span>
                                </td>
                                @endforeach

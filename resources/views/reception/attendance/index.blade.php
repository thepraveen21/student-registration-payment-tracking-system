        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ $uniqueCourses ?? 0 }}</p>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="px-6 py-4 bg-gray-50 border-b border-gray-200 flex justify-between items-center">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Today: {{ now()->format('F d, Y') }}</p>
            </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <!-- Contact -->
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{ $attendance->student->student_phone }}</div>
                                </td>
                                
                                <!-- Course -->
                                <td class="px-6 py-4">
                                    <div class="text-sm font-medium text-gray-900">{{ $attendance->student->course->name ?? 'N/A' }}</div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium {{ $status == 'Paid' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                                        {{ $status }}
                                    </span>
                                </td>
                                @endforeach

...
<head>
    ...
    <title>@yield('title', 'Reception Dashboard') | Student Portal</title>
...
<body class="bg-gray-50">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="sidebar text-white p-4 fixed h-full" id="sidebar">
            ...
            <nav class="space-y-2">
                <a href="{{ route('reception.dashboard') }}" class="flex items-center py-2 px-4 nav-link {{ request()->routeIs('reception.dashboard') ? 'active' : '' }}">
                    <i class="fas fa-tachometer-alt w-5"></i>
                    <span class="ml-3 nav-text">Dashboard</span>
                </a>
                <a href="{{ route('reception.students.index') }}" class="flex items-center py-2 px-4 nav-link {{ request()->routeIs('reception.students.*') ? 'active' : '' }}">
                    <i class="fas fa-user-graduate w-5"></i>
                    <span class="ml-3 nav-text">Students</span>
                </a>
                <a href="{{ route('reception.payments.index') }}" class="flex items-center py-2 px-4 nav-link {{ request()->routeIs('reception.payments.*') ? 'active' : '' }}">

...
<body class="bg-gray-50">
    <div class="flex min-h-screen">
        ...
        <div class="sidebar text-white p-4 fixed h-full">
            ...
            <nav class="space-y-2">
                <a href="{{ route('dashboard') }}" class="flex items-center py-2 px-4 nav-link active">
                    <i class="fas fa-tachometer-alt w-5"></i>
                    <span class="ml-3 nav-text">Dashboard</span>
                </a>
                <a href="{{ route('admin.students.index') }}" class="flex items-center py-2 px-4 nav-link">
                    <i class="fas fa-user-graduate w-5"></i>
                    <span class="ml-3 nav-text">Students</span>
                </a>
                <a href="{{ route('admin.payments.index') }}" class="flex items-center py-2 px-4 nav-link">
                ...
                <a href="{{ route('admin.settings.index') }}" class="flex items-center py-2 px-4 nav-link">

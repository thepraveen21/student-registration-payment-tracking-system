        ...
        <div class="sidebar text-white p-6 fixed h-full" id="sidebar">
            ...
            <nav class="space-y-2">
                ...
                <a href="{{ route('dashboard') }}" 
                   class="flex items-center py-3 px-4 nav-link {{ str_starts_with($currentRoute, 'dashboard') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin.students.index') }}" 
                   class="flex items-center py-3 px-4 nav-link {{ str_contains($currentRoute, 'students') ? 'active' : '' }}">
                    <div class="w-6 h-6 flex items-center justify-center">
                ...
                <a href="{{ route('admin.payments.index') }}" 
                   class="flex items-center py-3 px-4 nav-link {{ str_contains($currentRoute, 'payments') ? 'active' : '' }}">
                    <div class="w-6 h-6 flex items-center justify-center">
                ...
                <a href="{{ route('admin.reports.index') }}" 
                   class="flex items-center py-3 px-4 nav-link {{ str_contains($currentRoute, 'reports') ? 'active' : '' }}">
                    <div class="w-6 h-6 flex items-center justify-center">
                ...
                <a href="{{ route('admin.settings.index') }}" 
                   class="flex items-center py-3 px-4 nav-link {{ str_contains($currentRoute, 'settings') ? 'active' : '' }}">
                    <div class="w-6 h-6 flex items-center justify-center">

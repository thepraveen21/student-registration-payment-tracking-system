...
<body>
    ...
    <div class="container">
        <!-- Logo -->
        <img src="{{ asset('images/1.jpg') }}" alt="Logo" style="width:90px;height:90px;border-radius:50%;border:3px solid white;box-shadow:0 4px 10px rgba(0,0,0,0.3);margin-bottom:20px;">
        ...
        <!-- Footer -->
        <div class="footer">
            &copy; {{ date('Y') }} Student Registration & Payment Tracking System • All Rights Reserved
        </div>
    </div>

        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
            ...
            <div class="mt-4 sm:mt-0">
                <div class="flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 sm:space-x-3">
                    ...
                    <a href="{{ route('admin.reports.course-wise-students', ['export' => 'pdf']) }}" 
        ...
        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200 p-6 mb-8">
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                ...
                <div class="text-center">
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-1">{{ $courses->sum('students_count') }}</p>
                </div>
                <div class="text-center">
                    <p class="text-sm font-medium text-blue-600">Avg Students per Course</p>
                    <p class="text-3xl font-bold text-gray-900 mt-1">{{ number_format($courses->avg('students_count'), 1) }}</p>
                </div>
            </div>
        </div>
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <div class="text-sm text-gray-700 mb-4 sm:mb-0">
                        Showing <span class="font-semibold">{{ $courses->count() }}</span> courses with a total of 
                        <span class="font-semibold">{{ $courses->sum('students_count') }}</span> students
                    </div>
                    <div class="text-sm text-gray-600">

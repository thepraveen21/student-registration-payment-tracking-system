...
<div class="container mx-auto px-4 sm:px-8">
    <div class="py-8">
        ...
        <!-- Export Button -->
        <div class="mb-4">
            <a href="{{ route('admin.reports.course-wise-students', ['export' => 'pdf']) }}" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
                ...
                <table class="min-w-full leading-normal">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                <p class="text-gray-900 whitespace-no-wrap">{{ $course->students_count }}</p>
                            </td>
                        </tr>
                        @empty
                        <tr>

                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select name="month_number" id="month_number" 
                                ...
                                @for ($i = 1; $i <= 12; $i++)
                                    <option value="{{ $i }}" {{ old('month_number', $payment->month_number) == $i ? 'selected' : '' }}>Month {{ $i }}</option>
                                @endfor
                            </select>
                            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                                <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="notes" 
                                  ...
                                  placeholder="Add any additional notes or comments about this payment">{{ old('notes', $payment->notes) }}</textarea>
                    </div>
                </div>

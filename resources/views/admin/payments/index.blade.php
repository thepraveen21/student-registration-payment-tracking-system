        ...
        <div class="bg-white rounded-xl shadow-md p-6 border border-gray-100">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">Rs.{{ number_format($totalAmount, 2) }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-6 border border-gray-100">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">Rs.{{ number_format($todayAmount, 2) }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-6 border border-gray-100">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">Rs.{{ number_format($thisMonthAmount, 2) }}</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div class="text-sm text-gray-700 mb-4 sm:mb-0">
                    ...
                    <span class="font-semibold">{{ $payments->total() }}</span> payment records
                </div>

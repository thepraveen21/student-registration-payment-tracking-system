                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="address" 
                                      ...
                                      rows="3"
                                      class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200"
                                      placeholder="Enter complete address">{{ $settings['address'] ?? '' }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <select name="payment_gateway" id="payment_gateway" 
                                    ...
                                    <option value="cash" {{ (isset($settings['payment_gateway']) && $settings['payment_gateway'] == 'cash') ? 'selected' : '' }}>Cash Payments Only</option>
                                    <option value="stripe" {{ (isset($settings['payment_gateway']) && $settings['payment_gateway'] == 'stripe') ? 'selected' : '' }}>Stripe</option>
                                    <option value="paypal" {{ (isset($settings['payment_gateway']) && $settings['payment_gateway'] == 'paypal') ? 'selected' : '' }}>PayPal</option>
                                    <option value="razorpay" {{ (isset($settings['payment_gateway']) && $settings['payment_gateway'] == 'razorpay') ? 'selected' : '' }}>Razorpay</option>
                                </select>
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <select name="enable_registration" id="enable_registration" 
                                    ...
                                    <option value="1" {{ (isset($settings['enable_registration']) && $settings['enable_registration'] == 1) ? 'selected' : '' }}>Enable Registration</option>
                                    <option value="0" {{ (isset($settings['enable_registration']) && $settings['enable_registration'] == 0) ? 'selected' : '' }}>Disable Registration</option>
                                </select>
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
